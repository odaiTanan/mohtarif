  ...
  return (
    <main className="space-y-6">
      <section className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-blue-50 to-slate-100 p-6 shadow-lg shadow-slate-200/50">
          <p className="text-sm tracking-[0.2em] text-blue-600">لوحة التحكم</p>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {[
              ...
              ['إدارة المحتوى', '/dashboard/academies', 'إدارة الأقسام والدورات'],
