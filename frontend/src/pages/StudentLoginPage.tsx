    ...
    <main className="mx-auto flex min-h-screen max-w-6xl items-center px-6 py-10 lg:px-10" dir="rtl" lang="ar">
      <div className="grid w-full gap-8 lg:grid-cols-2">
        <section className="space-y-5">
          <span className="inline-flex rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-2 text-sm text-purple-600">
            دخول الطلاب
          </span>
          ...
          <p className="max-w-xl text-sm leading-7 text-slate-600 sm:text-base">
            أدخل بياناتك للوصول إلى لوحة التحكم وبدء الاختبارات
          </p>
        </section>
        ...
        >
          <div className="space-y-4">
            <label className="block space-y-2">
              ...
              <input
                className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-purple-500/50"
                type="email"
                value={email}
          ...
          <button
            className="mt-6 w-full rounded-2xl bg-purple-600 px-4 py-3 font-semibold text-white transition hover:bg-purple-700 disabled:cursor-not-allowed disabled:opacity-60"
            type="submit"
